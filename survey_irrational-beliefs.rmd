...
this is also not true when comparing two and three factors. It is minimum when comparing three with four 
...
# questions that Dr Essam insisted to have
...
summary(mod_44_graded2)

Mod2.REL <- fscores(mod_44_graded2, method= "EAP", returnER = T)

```

which questions in which domain?
